 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.variCell.impl.OptionalImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OptionalImpl extends MinimalEObjectImpl.Container implements Optional
{
  ...
  {
    return VariCellPackage.Literals.OPTIONAL;
  }
  ...
  public EList<String> getValues()
  {
    if (values == null)
    {
      values = new EDataTypeEList<String>(String.class, this, VariCellPackage.OPTIONAL__VALUES);
    }
    return values;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case VariCellPackage.OPTIONAL__VALUES:
        return getValues();
    }
