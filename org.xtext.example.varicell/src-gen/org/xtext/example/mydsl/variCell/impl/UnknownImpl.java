 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.variCell.impl.UnknownImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnknownImpl extends MinimalEObjectImpl.Container implements Unknown
{
  ...
  {
    return VariCellPackage.Literals.UNKNOWN;
  }
  ...
  public EList<String> getValues()
  {
    if (values == null)
    {
      values = new EDataTypeEList<String>(String.class, this, VariCellPackage.UNKNOWN__VALUES);
    }
    return values;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case VariCellPackage.UNKNOWN__VALUES:
        return getValues();
    }
